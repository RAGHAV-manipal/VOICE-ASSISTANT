...
class infow1():
    ...
    def get_info1(self, query):
       ...
       # search = self.driver.find_element_by_xpath('//*[@id="searchInput"]')
        #search = self.driver.find_element(By.XPATH, '/html/body/div[5]/div/div[13]/div[1]/div[2]/div[2]/div/div/div[1]/div/div/div/div/div/div/div[1]/div/span/a/h3')
